...
const Services = () => {
  ...
  return (
    ...
    <div id='services' className='my-48 '>
      <div className="w-10/12 mx-auto mb-5 md:mb-10">
        <h1 className="font-nunito text-2xl md:text-3xl font-bold text-primary-100">Services We Provide</h1>
      </div>
      <div className="flex flex-col gap-16">
        <motion.div
          ...
          className="bg-white shadow-3xl rounded-2xl lg:justify-between gap-6 md:gap-12 flex flex-col items-center    sm:w-3/4  lg:w-10/12 w-10/12 mx-auto px-4 py-8 lg:flex-row-reverse  md:px-20">
          <motion.img
        ...
        <motion.div
          ...
          className="bg-white shadow-3xl rounded-2xl lg:justify-between gap-6 md:gap-12 flex flex-col items-center   w-10/12 sm:w-3/4  lg:w-10/12 mx-auto px-4 py-8 lg:flex-row md:px-20">
          <motion.img
            variants={ leftCardAnimate }
            className="md:w-1/2"
            src={ ServicesTwo }
        ...
        <motion.div
          ...
          className="bg-white shadow-3xl rounded-2xl lg:justify-between gap-6 md:gap-12  flex flex-col items-center  w-10/12 sm:w-3/4  lg:w-10/12 mx-auto px-4 py-8 lg:flex-row-reverse  md:px-20">
          <motion.img
            variants={ rightCardAnimate }
            className="md:w-1/2"
            src={ ServicesThree }
